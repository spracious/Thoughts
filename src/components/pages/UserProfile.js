             ...
             <img src="https://i.imgur.com/wvxPV9S.png" height="100" width="100" />
              ...
              <span class="name mt-3">Eleanor Pena</span>
               ...
               <div class="d-flex flex-row justify-content-center align-items-center gap-2">
                 <span class="idd1">eleanor@gmail.com</span>
                   ...
                   <div class="d-flex flex-row justify-content-center align-items-center mt-3">
                     <span class="number">1069
                       ...
                       <div class=" d-flex mt-2">
                         <Link to="/edit"><button class="btn1 btn-dark">Edit Profile</button> </Link>
                         </div>
                          <div class="text mt-3"> <span>Eleanor Pena is a creator of minimalistic x bold graphics and digital artwork.<br/> Artist/ Creative Director by Day #NFT minting@ with FND night. 
                          </span>
                           </div> 
